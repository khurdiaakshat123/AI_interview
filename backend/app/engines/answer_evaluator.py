...
class SemanticEvaluationResult(BaseModel):
    ...
    objective_coverage: float = Field(default=0.5, ge=0.0, le=1.0)
    completeness: float = Field(default=0.5, ge=0.0, le=1.0)
    technical_validity: float = Field(default=0.5, ge=0.0, le=1.0)
    depth_demonstrated: float = Field(default=0.5, ge=0.0, le=1.0)
    ...
    ownership: Optional[float] = Field(default=None, ge=0.0, le=1.0)
